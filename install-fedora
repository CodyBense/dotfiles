...
flatpak install flathub io.github.sxyazi.yazi -y
...
echo "Installing Terminess"
curl -L -o ~/Downloads https://github.com/ryanoasis/nerd-fonts/releases/download/v3.4.0/Terminus.zip
sudo unzip ~/Downloads/Terminus.zip
sudo cp ~/Downloads/*.ttf ~/.local/share/fonts
sudo fc-cache -v
sudo rm ~/Downloads/*
...
cargo install --features cmd --path ~/kanata
